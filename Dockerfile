...
MAINTAINER Nicolas Dordet <ndordet@redhat.com>

# Labels consumed by Red Hat build service
LABEL com.redhat.component="jenkins-slave-base-ose-ansible" \
      name="ndox/ami_builder" \
      version="3.6" \
      architecture="x86_64" \
      release="1" \
      io.k8s.display-name="Jenkins Slave Base for Biulding AMI" \
...
io.openshift.tags="openshift,jenkins,slave,packer,terraform,ami"
...
#inspired by https://github.com/openshift/jenkins/blob/master/slave-base/Dockerfile.rhel7
